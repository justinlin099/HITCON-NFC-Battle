/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: be37e3c01989d5a36fbd8fd672c18e41)
...
interface __BaseEnv_CloudflareBindings {
	...
	ASSETS: Fetcher;
	JWT_ISSUER: "hitcon-2026-staging" | "hitcon-2026";
	JWT_AUDIENCE: "nfc-battle-api-server-staging" | "nfc-battle-api-server";
	PRINT_CARD_MAX_UPLOAD_BYTES: "4194304";
	SCOREBOARD_REFRESH_SECONDS: "10";
	JWT_SECRET: string;
	STAFF_DANGER_TOKEN: string;
	SCOREBOARD_COORDINATOR: DurableObjectNamespace<import("./src/worker").ScoreboardCoordinator>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "ScoreboardCoordinator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "JWT_ISSUER" | "JWT_AUDIENCE" | "PRINT_CARD_MAX_UPLOAD_BYTES" | "SCOREBOARD_REFRESH_SECONDS" | "JWT_SECRET" | "STAFF_DANGER_TOKEN">> {}
}
