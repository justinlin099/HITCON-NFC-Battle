...
export async function createTestServer(): Promise<TestServer> {
  ...
  const env = {
    ...
    USER_BOOTSTRAP_RATE_LIMITER: new TestRateLimit(3) as unknown as RateLimit,
    USER_RARE_RATE_LIMITER: new TestRateLimit(5) as unknown as RateLimit,
    USER_SENSITIVE_RATE_LIMITER: new TestRateLimit(10) as unknown as RateLimit,
    USER_HEAVY_RATE_LIMITER: new TestRateLimit(20) as unknown as RateLimit,
    USER_PROFILE_RATE_LIMITER: new TestRateLimit(30) as unknown as RateLimit,
    USER_STANDARD_RATE_LIMITER: new TestRateLimit(60) as unknown as RateLimit,
