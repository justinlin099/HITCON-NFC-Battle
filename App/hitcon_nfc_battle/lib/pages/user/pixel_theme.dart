...
class PixelTheme {
  static const Map<PixelScheme, PixelPalette> schemes =
      <PixelScheme, PixelPalette>{
  ...
  static PixelPalette getPalette(PixelScheme scheme) =>
      schemes[scheme] ?? schemes[defaultScheme]!;
